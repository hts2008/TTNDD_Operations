...
> **Source:** `apps/api/prisma/schema.prisma` | 60 models → 60 PostgreSQL tables
...
### Multi-Tenant Column
- **All 57 tables** (except `organizations`, `users`, `release_gate_reports`) have `org_id UUID NOT NULL`
