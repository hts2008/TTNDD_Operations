...
> **Source:** `apps/api/prisma/migrations/` | 8 migration files
...
| 8 | 20260313020000 | `m2b_project_views_risks` | plan_templates, project_checklists, project_risks | M2 Projects (M2-B sprint extension) |

**All 63 models have migration coverage across 8 files.**
